...
const projects = [
  {
    ...
    description: "A comprehensive weather monitoring system with real-time data collection from hardware stations and web dashboard for government officials and citizens.",
  ...
  {
    title: "Jobowl",
    description: "Desktop job application tracker with intuitive GUI for tracking applications, managing statuses, and monitoring job search progress. Built for GNOME desktop.",
  ...
  {
    title: "Databox",
    description: "A student scheduler and progress tracker that runs in the background for real-time notification and alerts. Developed using C#, .NET, MySQL, and Apache Server",
  ...
  {
    title: "Knowt",
    description: "Advanced article summarization tool with AI-powered sentiment analysis, built using Python Flask and Firebase for secure content processing and management.",
  ...
  <div class="min-h-screen bg-white text-black font-mono">
    ...
    <header class="border-b border-gray-200 sticky top-0 bg-white z-50">
      <div class="max-w-6xl mx-auto px-6 py-6 flex justify-between items-center">
        <div class="text-xl font-bold">Regee Casaña</div>
    ...
    <main class="max-w-6xl mx-auto px-6">
      ...
      <section class="py-20 border-b border-gray-200">
        <div class="max-w-3xl">
          ...
          <div class="text-lg text-gray-600 space-y-4">
            <p>Computer science graduate with latin honor. Currently working as Lead Software Engineer at Kloudtech Corp.</p>
            <p>I build weather monitoring systems, time tracking applications, and AI-powered tools that solve real-world problems.</p>
          </div>
        </div>
      </section>
          ...
          >
            <div class="grid md:grid-cols-12 gap-8 items-start">
              ...
              <div class="md:col-span-3 flex justify-end">
                <div class="text-sm text-gray-500 group-hover:text-black transition-colors">
                  View Project →
                </div>
              </div>
            </div>
        ...
        <div class="grid gap-8">
          <div class="grid md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-9">
              <h3 class="font-semibold mb-2">Software Engineer</h3>
              <div class="text-gray-600 mb-2">Kloudtech Corp</div>
              <p class="text-sm text-gray-600">Lead Software Engineer leading a team of three developers. Architected and developed a comprehensive weather monitoring system with real-time data collection, IoT integration, and web dashboard for clients.</p>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-9">
              <h3 class="font-semibold mb-2">Software Engineering Intern</h3>
              <div class="text-gray-600 mb-2">Kloudtech Corp</div>
              <p class="text-sm text-gray-600">Learned about IoT, applied cybersecurity, enhanced and maintained company's web app, and optimized the codebase.</p>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-9">
              <h3 class="font-semibold mb-2">Bachelor of Science in Computer Science</h3>
              <div class="text-gray-600 mb-2">Bataan Peninsula State University</div>
              <p class="text-sm text-gray-600">Graduated Cum Laude with latin honor, specializing in software engineering, algorithms, and system design.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" class="py-20">
        <h2 class="text-2xl font-bold mb-12">Contact</h2>
        <div class="grid md:grid-cols-2 gap-12">
          <div class="space-y-6">
            <p class="text-gray-600">
              I'm always interested in discussing new opportunities, collaborations, or just having a conversation about technology and software development.
            </p>
            <div class="space-y-2">
              <div class="text-sm">
              ...
              <div class="text-sm">
                ...
                <a href="https://linkedin.com/in/rekasa" target="_blank" class="ml-2 hover:underline">linkedin.com/in/rekasa</a>
              </div>
              <div class="text-sm">
                <span class="text-gray-500">GitHub:</span>
                <a href="https://github.com/rekasa7000" target="_blank" class="ml-2 hover:underline">github.com/rekasa7000</a>
              </div>
              <div class="text-sm">
